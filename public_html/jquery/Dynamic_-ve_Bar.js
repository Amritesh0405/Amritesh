$(document).ready(function () {
    function Dynamicchart() {
        ...
        $.each(response.response, function (key, value) {
            second_array.push({"timestamp": value.timestamp, "playdur": value.playdur});
        });
        var margin = {
            top: 30,
            right: 20,
...
//                }));
        ...
        var maxtimestamp = d3.max(second_array, function (d) {
             console.log("hh",d.timestamp)
            return d.timestamp;
        });
        var mintimestamp = d3.min(second_array, function (d) {
            return d.timestamp;
        });
        console.log("sss",maxtimestamp)
        console.log("srrrrrs",mintimestamp)
